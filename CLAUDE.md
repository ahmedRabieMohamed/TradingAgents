...
- 002-market-overview-news: Added Python 3.10+ (backend), TypeScript 5.x (frontend) + FastAPI, yfinance (backend); React 18, Zustand (frontend) — all already installed from 001
