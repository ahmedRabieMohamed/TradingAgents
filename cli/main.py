...
class MessageBuffer:
    ...
    def _update_final_report(self):
        ...
        egyptian_sections = ["egyptian_market_report", "egyptian_news_report", "egyptian_fundamentals_report"]
        ...
        elif any(self.report_sections.get(section) for section in egyptian_sections):
            report_parts.append("## Egyptian Analyst Team Reports")
            if self.report_sections.get("egyptian_market_report"):
                report_parts.append(
                    f"### Egyptian Market Analysis\n{self.report_sections['egyptian_market_report']}"
                )
            if self.report_sections.get("egyptian_news_report"):
                report_parts.append(
                    f"### Egyptian News Analysis\n{self.report_sections['egyptian_news_report']}"
                )
            if self.report_sections.get("egyptian_fundamentals_report"):
                report_parts.append(
